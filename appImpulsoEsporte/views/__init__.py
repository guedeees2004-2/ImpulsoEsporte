...
from .equipe_views import (
    ...
    buscar_times, pagina_equipe_disponivel, minha_equipe, visualizar_perfil_equipe,listar_atletas_da_equipe,adicionar_partida,editar_partida, excluir_partida,
)
...
__all__ = [
    ...
    'buscar_patrocinadores','listar_atletas_da_equipe', 'adicionar_partida', 'editar_partida', 'excluir_partida',
]
