...
from .equipe_views import (
    ...
    buscar_times, pagina_equipe_disponivel, minha_equipe, 
    visualizar_perfil_equipe, listar_atletas_da_equipe, adicionar_partida
)
...
__all__ = [
    ...
    'listar_atletas_da_equipe', 'adicionar_partida',
